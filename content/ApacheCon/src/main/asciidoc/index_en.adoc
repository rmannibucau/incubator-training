...
image:romain/twitter.png[width=100%]
image:romain/blog.png[width=100%]
image:romain/github.png[width=100%]
image:romain/yupiik.png[width=100%]
...
[%step]
* JPA issue SQL statements. All database are all SQL based but make it vary/enhance it
...
[source]
----
[main] INFO openjpa.Runtime - Starting OpenJPA 3.1.3-SNAPSHOT
[main] INFO openjpa.jdbc.JDBC - Using dictionary class "org.apache.openjpa.jdbc.sql.HerdDBDictionary" (HerdDB  ,HerdDB 0.0).
[main] INFO openjpa.jdbc.JDBC - Connected to HerdDB version 0.0 using JDBC driver HerdDB version 0.0.
----
