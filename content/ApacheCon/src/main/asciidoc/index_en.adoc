...
|===
| Criteria                    | H2    | MySQL | Herdb (embedded) | HerdDB remote (sync) | HerdDB remote (async flush)
| First findall               | 154ms | 176ms | 187ms | 196ms | 169ms
| Hot   findall               | 1.0ms | 1.0ms | 5.5ms | 2.9ms | 2.8ms
| Startup/DS creation (empty) | 463ms | 764ms | 948ms | 393ms | 393ms
|===

[.medium]
NOTE: similar figures for a real application, still in local mode. 35 tables (max 75 columns in a table), 35 indices, 302 columns, 10 select all executed in main tables.
...
> Databases are moving from vendor reserved area to developers are in a cloud native way. Be prepared!
